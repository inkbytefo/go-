...
func main() {
	...
	if *versionFlag {
		fmt.Printf("GO-Minus Test Aracı v%s\n", version)
		os.Exit(0)
	}
...
func runTests(dirs []string) {
	fmt.Println("GO-Minus testleri çalıştırılıyor...")
...
func isTestFile(path string) bool {
	...
	// Dosya içeriğini kontrol et (gerçek implementasyonda bu kısım GO-Minus test fonksiyonlarını arayacak)
	return true
}

// Yardım mesajını yazdır
func printHelp() {
	fmt.Println("GO-Minus Test Aracı")
	fmt.Println("\nKullanım:")
